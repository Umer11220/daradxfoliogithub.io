            ...
            <div class="top_nav">
                <div class="container">
                    <ul class="list-inline info">
                        <li><a href="#"><span class="fa fa-phone"></span> 0312-2096659</a></li>
                        <li><a href="#"><span class="fa fa-envelope"></span> usa11220.us@gmail.com</a></li>
                        <li><a href="#"><span class="fa fa-clock-o"></span> 24/7</a></li>
                    </ul>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-menu">
                        <ul class="nav navbar-nav menu">
                            ...
                            <li><a href="constructionorder.php">Project place</a></li>
                        </ul>
                    </div>
                </div>   
            </nav><!-- Navbar end -->
                    ...
                    <div class="item active">
                        ...
                        <div class="overlay">
                            <div class="carousel-caption">
                                ...
                                <p>Confidence in pipeline construction. In-house or on-site, we handle fabrication and installation for any size steel, poly, and fiber line. For our team of welders and technicians, no feat is too big.</p>
                    ...
                    <div class="item">
                        ...
                        <div class="overlay">
                            <div class="carousel-caption">
                                ...
                                <h1>Construction Services</h1>
                                <h1 class="second_heading">Creative & Professional</h1>
                                <p>We are skilled experts when it comes to completing gas plant installations, pipeline maintenance, roustabout services, fabrication, well hookups, and more.</p>
                                <a  class="btn know_btn">know more</a>
                                <a  class="btn know_btn">view project</a>
                            </div>					
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-7 col-md-6">
                        <div class="about_content">
                            ...
                            <p>Providing oil and gas pipeline construction and maintenance services to leading U.S. energy companies, we emphasize safety, work quality, and employee development to maximize client satisfaction. With over 75 years of combined experience, we won’t let you down.</p>
                            <p>From 200mmcf Cryo plants and 9000bbi per day stabilizers, Bold Pipeline Services has the experience needed to address many industry challenges. Our team strives to build strong relationships between employees, engineers, subcontractors, and landowners so any projects are completed safely, timely, and all within budget.</p>
                            <a  class="btn know_btn">know more</a>
                        </div>
                    </div>
